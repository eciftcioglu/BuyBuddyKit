...
@interface BuyBuddyBleHandler : NSObject <CBPeripheralDelegate, CBCentralManagerDelegate>
...
@property (nonatomic, copy) NSIndexPath * _Nullable currentIndexPath;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithProducts:(NSDictionary<NSString *, NSString *> * _Nonnull)products OBJC_DESIGNATED_INITIALIZER;
...
@interface BuyBuddyHitagManager : NSObject <CLLocationManagerDelegate>
...
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)adjustImageAndTitleOffsets;
@end
...
@interface FinalizePaymentViewController : UIViewController <UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource>
...
- (void)didOpen:(NSNotification * _Nonnull)notification;
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
- (void)setSizePriceWithSize:(NSString * _Nonnull)size price:(float)price;
@end
...
@property (nonatomic, strong) IBOutlet ShoppingCartButton * _Null_unspecified cartButton;
@property (nonatomic, strong) IBOutlet CircleButton * _Null_unspecified addButton;
@property (nonatomic, strong) ShoppingCartButton * _Nullable userButton;
...
@interface ShoppingBasketViewController : UIViewController <UIScrollViewDelegate, UITableViewDataSource, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UITableViewDelegate>
...
SWIFT_CLASS("_TtC11BuyBuddyKit18ShoppingCartButton")
@interface ShoppingCartButton : UIButton
